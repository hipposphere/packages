...
version pinned in `native/rust-toolchain.toml`. It publishes them to the public
[`hipposphere/native-artifacts`](https://github.com/hipposphere/native-artifacts)
repository under a `hippo_zstandard-native-v<crate-version>` release. Native
