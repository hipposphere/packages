...
void main() {
  test('builds native-artifacts release URLs for Hippo CLI artifacts', () {
    ...
    expect(
      ...
      'https://github.com/hipposphere/native-artifacts/releases/download/'
      'hippo_cli-native-v0.1.0/hippo-cli-0.1.0-linux-x64.tar.gz',
    );
  });
}
